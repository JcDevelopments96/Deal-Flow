/* ============================================================================
   TERMS OF SERVICE — minimal but real ToS that gives DealTrack legal teeth
    ...
    <div style={{ maxWidth: 880, margin: "0 auto", padding: isMobile() ? "16px" : "32px 28px" }}>
      ...
      <Panel title="The short version" icon={<Shield size={16} />} accent style={{ marginBottom: 24 }}>
        <ul style={{ margin: 0, paddingLeft: 18, fontSize: 13, color: THEME.textMuted, lineHeight: 1.7 }}>
          <li>Use DealTrack to research and manage your own real-estate deals.</li>
          ...
          <li>We provide DealTrack "as is" — no guarantees about deal outcomes.</li>
        </ul>
      </Panel>

      <Section title="1. Acceptance of Terms">
        By creating an account or otherwise accessing DealTrack ("the Service"),
        you agree to these Terms of Service. If you don't agree, don't use the
        Service.
      </Section>

      <Section title="2. Account & Eligibility">
        You must be at least 18 years old to use DealTrack. You are responsible
      ...
      <Section title="3. Acceptable Use">
        ...
        <ul style={{ marginTop: 6, paddingLeft: 20, lineHeight: 1.7 }}>
          <li><strong>Scrape or harvest data</strong> from any DealTrack endpoint, page, or API response, whether by automated means or manual extraction at scale, except for your own personal use of search results within the application.</li>
          <li><strong>Resell, redistribute, or republish</strong> property listings, owner records, market data, or any other content obtained through DealTrack, including derivative works built on top of it.</li>
          <li><strong>Reverse engineer, decompile, or attempt to derive the source code</strong> of any part of DealTrack's frontend, backend, or proprietary algorithms (including but not limited to lead-scoring formulas, ranking logic, and aggregated market indexes).</li>
          <li><strong>Clone or imitate</strong> the visual design, brand, naming conventions, or product structure of DealTrack for use in a competing product.</li>
          ...
          <li><strong>Use DealTrack data for unlawful outreach</strong> — comply with CAN-SPAM, TCPA, the Do Not Call Registry, fair-housing laws, and applicable state regulations when contacting property owners.</li>
          <li><strong>Train AI/ML models</strong> on DealTrack's content, data, or interface without our prior written consent.</li>
        </ul>
      </Section>
      ...
      <Section title="5. Third-Party Services">
        DealTrack integrates with property data providers, mapping services,
      ...
      <Section title="6. Intellectual Property">
        DealTrack, the DealTrack logo, the "Find Local Pros" feature, the
        Wholesale Lead Finder workflow, and all proprietary algorithms,
        designs, and content are the property of DealTrack and protected by
      ...
      <Section title="7. Disclaimers">
        DealTrack is provided <strong>"as is"</strong> without warranties of
      ...
      <Section title="8. Limitation of Liability">
        To the fullest extent permitted by law, DealTrack and its operators
      ...
      <Section title="9. Termination">
        ...
        operational risk for us. You may stop using DealTrack and delete
        your account at any time.
      </Section>

      <Section title="10. Changes to These Terms">
        We may update these Terms occasionally. Material changes will be
        announced via the app or email. Continuing to use DealTrack after a
        change means you accept the updated Terms.
      </Section>

      <Section title="11. Governing Law">
        These Terms are governed by the laws of the United States and the
        State in which DealTrack is headquartered, without regard to
